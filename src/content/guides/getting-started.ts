        ...
        blocks: [
          {
            table: {
              ...
              rows: [
                ...
                ["❄️ [Ice](/schools/ice)", "The unkillable tank", "Low–Medium", "Highest", "Very forgiving, fights take longer"],
                ["⚡ [Storm](/schools/storm)", "Glass cannon", "Highest", "Lowest", "Spiky — huge hits, painful fizzles"],
                ["👁️ [Myth](/schools/myth)", "Minions & double-hits", "Medium–High", "Medium", "Clever toolkit, a bit technical"],
                ...
                ["⚖️ [Balance](/schools/balance)", "Jack-of-all-trades support", "Medium", "High", "Flexible, shines in teams"],
              ],
            },
          },
