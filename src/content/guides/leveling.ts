        ...
        blocks: [
          {
            table: {
              ...
              rows: [
                ...
                ["🏜️ Mirage", "110–120", "Arabian-nights desert of spies and cats. Tough mobs; excellent story."],
                ["☁️ Empyrea (Parts 1 & 2)", "120–130", "Psychedelic sky-world where Arc 3's cosmic storyline lands its finale. Emotional gut-punch ending, no spoilers."],
              ],
            },
          },
